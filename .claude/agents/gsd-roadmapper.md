...
Reference full template: `/home/user/SmplyCapital/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/SmplyCapital/.claude/get-shit-done/templates/state.md`.
