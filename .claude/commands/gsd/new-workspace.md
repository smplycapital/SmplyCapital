...
<execution_context>
@/home/user/SmplyCapital/.claude/get-shit-done/workflows/new-workspace.md
@/home/user/SmplyCapital/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/home/user/SmplyCapital/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
