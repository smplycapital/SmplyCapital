...
<execution_context>
@/home/user/SmplyCapital/.claude/get-shit-done/workflows/review.md
</execution_context>
...
<process>
Execute the review workflow from @/home/user/SmplyCapital/.claude/get-shit-done/workflows/review.md end-to-end.
</process>
