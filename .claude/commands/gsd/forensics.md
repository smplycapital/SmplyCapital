...
<execution_context>
@/home/user/SmplyCapital/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/home/user/SmplyCapital/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
